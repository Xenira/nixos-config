...
Item {
    ...
    implicitWidth: {
        if (list.count === 0)
            return 0;
        return NotiConfig.sizes.width + padding * 2;
    }
    implicitHeight: {
    ...
    ClippingWrapperRectangle {
        ...
        color: "transparent"
        bottomLeftRadius: Appearance.rounding
        bottomRightRadius: Appearance.rounding

        ListView {
            id: list

            model: ScriptModel {
                values: [...Noti.popups].reverse()
            }
            ...
            delegate: Item {
                ...
                required property Noti.Noti modelData
                ...
                implicitWidth: noti.implicitWidth
                implicitHeight: noti.implicitHeight + (idx === 0 ? 0 : Appearance.spacing.smaller)
                ...
                SequentialAnimation {
                    ...
                    Anim {
                        target: noti
                        property: "x"
                        to: (noti.x >= 0 ? NotiConfig.sizes.width : -NotiConfig.sizes.width) * 2
                ...
                SciFiRect {
                    ...
                    // color: "transparent"
                    radius: noti.radius
                    targetWidth: noti.implicitWidth
                    targetHeight: noti.implicitHeight
